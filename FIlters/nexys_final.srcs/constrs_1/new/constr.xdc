...
# IO_L24N_T3_RS0_15 Sch=reset
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { sel[0] }];
# IO_L3N_T0_DQS_EMCCLK_14 Sch=sel[0]
#set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { sel[1] }];
# IO_L6N_T0_D08_VREF_14 Sch=sel[1]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { sel1[0] }];
# IO_L13N_T2_MRCC_14 Sch=sel1[0]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { sel1[1] }]; 
#IO_L12N_T1_MRCC_14 Sch=sel1[1]
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { sel1[2] }]; 
#IO_L7N_T1_D10_14 Sch=sel1[2]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { sel1[3] }];
# IO_L17N_T2_A13_D29_14 Sch=sel1[3]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { sel2[0] }]; 
#IO_L5N_T0_D07_14 Sch=sel2[0]
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { sel2[1] }];
# IO_L24N_T3_34 Sch=sel2[1]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { sel2[2] }]; 
#IO_25_34 Sch=sel2[2]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { sel2[3] }];
# IO_L15P_T2_DQS_RDWR_B_14 Sch=sel2[3]
...
#IO_L8N_T1_AD14N_35 Sch=vgaRed[0]
set_property -dict { PACKAGE_PIN B4    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[1] }];
# IO_L7N_T1_AD6N_35 Sch=vgaRed[1]
set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[2] }];
# IO_L1N_T0_AD4N_35 Sch=vgaRed[2]
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { vgaRed[3] }]; 
#IO_L8P_T1_AD14P_35 Sch=vgaRed[3]

set_property -dict { PACKAGE_PIN C6    IOSTANDARD LVCMOS33 } [get_ports { vgaGreen[0] }];##IO_L3N_T0_DQS_AD5N_35 Sch=vgaGreen[1]
